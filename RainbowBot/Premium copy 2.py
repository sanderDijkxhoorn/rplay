##vervang dit
bot_key="MzY5NTMwNDMwMTUzNjg3MDQz.Dta9_Q.sixNdxo8m-L4Uh6jCBldoPMl_Xo"
...
async def on_message(message):
        ...
        if message.content.startswith("=owners"):
                await client.send_message(message.channel, "going fast asf")
                hue=0
                if message.content.strip().startswith("=owners "):
